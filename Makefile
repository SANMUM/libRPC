...
# $(PATH_BIN)/test_tcp $(PATH_BIN)/test_client $(PATH_BIN)/test_rpc_client $(PATH_BIN)/test_rpc_server $(PATH_BIN)/test_event
# ALL_TESTS : $(PATH_BIN)/test_log

TEST_CASE_OUT := $(PATH_BIN)/test_log $(PATH_BIN)/test_eventloop $(PATH_BIN)/test_tcp $(PATH_BIN)/test_client  $(PATH_BIN)/test_rpc_client $(PATH_BIN)/test_rpc_server $(PATH_BIN)/test_event
...
# $(PATH_BIN)/test_event: $(LIB_OUT)
# 	$(CXX) $(CXXFLAGS) $(PATH_TESTCASES)/test_event.cc -o $@ $(LIB_OUT) $(LIBS) -ldl -pthread
